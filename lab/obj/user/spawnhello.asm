...
umain(int argc, char **argv)
{
  ...
  800076:	c7 44 24 08 84 2b 80 	movl   $0x802b84,0x8(%esp)
  80007d:	00 
  80007e:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  800085:	00 
  800086:	c7 04 24 9c 2b 80 00 	movl   $0x802b9c,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800130:	c7 04 24 b8 2b 80 00 	movl   $0x802bb8,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002cd:	0f be 80 db 2b 80 00 	movsbl 0x802bdb(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800485:	c7 44 24 08 f3 2b 80 	movl   $0x802bf3,0x8(%esp)
  80048c:	00 
  ...
  8004dc:	75 05                	jne    8004e3 <vprintfmt+0x185>
				p = "(null)";
  8004de:	be ec 2b 80 00       	mov    $0x802bec,%esi
			if (width > 0 && padc != '-')
