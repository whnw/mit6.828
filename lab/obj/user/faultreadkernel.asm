	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800235:	0f be 80 d1 24 80 00 	movsbl 0x8024d1(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800350:	ff 24 95 20 26 80 00 	jmp    *0x802620(,%edx,4)
  ...
  800410:	c7 44 24 08 b9 28 80 	movl   $0x8028b9,0x8(%esp)
  800417:	00 
  ...
  800444:	75 05                	jne    80044b <vprintfmt+0x185>
				p = "(null)";
  800446:	be e2 24 80 00       	mov    $0x8024e2,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800a9e:	00 
  800a9f:	c7 44 24 08 e3 27 80 	movl   $0x8027e3,0x8(%esp)
  800aa6:	00 
  800aa7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800aae:	00 
  800aaf:	c7 04 24 00 28 80 00 	movl   $0x802800,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b30:	00 
  800b31:	c7 44 24 08 e3 27 80 	movl   $0x8027e3,0x8(%esp)
  800b38:	00 
  800b39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b40:	00 
  800b41:	c7 04 24 00 28 80 00 	movl   $0x802800,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b83:	00 
  800b84:	c7 44 24 08 e3 27 80 	movl   $0x8027e3,0x8(%esp)
  800b8b:	00 
  800b8c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b93:	00 
  800b94:	c7 04 24 00 28 80 00 	movl   $0x802800,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bd6:	00 
  800bd7:	c7 44 24 08 e3 27 80 	movl   $0x8027e3,0x8(%esp)
  800bde:	00 
  800bdf:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800be6:	00 
  800be7:	c7 04 24 00 28 80 00 	movl   $0x802800,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c29:	00 
  800c2a:	c7 44 24 08 e3 27 80 	movl   $0x8027e3,0x8(%esp)
  800c31:	00 
  800c32:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c39:	00 
  800c3a:	c7 04 24 00 28 80 00 	movl   $0x802800,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c7c:	00 
  800c7d:	c7 44 24 08 e3 27 80 	movl   $0x8027e3,0x8(%esp)
  800c84:	00 
  800c85:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c8c:	00 
  800c8d:	c7 04 24 00 28 80 00 	movl   $0x802800,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ccf:	00 
  800cd0:	c7 44 24 08 e3 27 80 	movl   $0x8027e3,0x8(%esp)
  800cd7:	00 
  800cd8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cdf:	00 
  800ce0:	c7 04 24 00 28 80 00 	movl   $0x802800,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800d44:	00 
  800d45:	c7 44 24 08 e3 27 80 	movl   $0x8027e3,0x8(%esp)
  800d4c:	00 
  800d4d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d54:	00 
  800d55:	c7 04 24 00 28 80 00 	movl   $0x802800,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  800ec1:	42                   	inc    %edx
  800ec2:	8b 04 95 8c 28 80 00 	mov    0x80288c(,%edx,4),%eax
  ...
  800edd:	c7 04 24 10 28 80 00 	movl   $0x802810,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80113b:	c7 04 24 51 28 80 00 	movl   $0x802851,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801211:	c7 04 24 6d 28 80 00 	movl   $0x80286d,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8012c8:	c7 04 24 30 28 80 00 	movl   $0x802830,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80154c:	c7 44 24 0c a0 28 80 	movl   $0x8028a0,0xc(%esp)
  801553:	00 
  801554:	c7 44 24 08 a7 28 80 	movl   $0x8028a7,0x8(%esp)
  80155b:	00 
  80155c:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  801563:	00 
  801564:	c7 04 24 bc 28 80 00 	movl   $0x8028bc,(%esp)
  80156b:	e8 00 0b 00 00       	call   802070 <_panic>
	assert(r <= PGSIZE);
  801570:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801575:	7e 24                	jle    80159b <devfile_read+0x84>
  801577:	c7 44 24 0c c7 28 80 	movl   $0x8028c7,0xc(%esp)
  80157e:	00 
  80157f:	c7 44 24 08 a7 28 80 	movl   $0x8028a7,0x8(%esp)
  801586:	00 
  801587:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  80158e:	00 
  80158f:	c7 04 24 bc 28 80 00 	movl   $0x8028bc,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801662:	c7 44 24 04 d3 28 80 	movl   $0x8028d3,0x4(%esp)
  801669:	00 
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801a74:	c7 44 24 0c df 28 80 	movl   $0x8028df,0xc(%esp)
  801a7b:	00 
  801a7c:	c7 44 24 08 a7 28 80 	movl   $0x8028a7,0x8(%esp)
  801a83:	00 
  801a84:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  801a8b:	00 
  801a8c:	c7 04 24 f4 28 80 00 	movl   $0x8028f4,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801ad2:	c7 44 24 0c 00 29 80 	movl   $0x802900,0xc(%esp)
  801ad9:	00 
  801ada:	c7 44 24 08 a7 28 80 	movl   $0x8028a7,0x8(%esp)
  801ae1:	00 
  801ae2:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  801ae9:	00 
  801aea:	c7 04 24 f4 28 80 00 	movl   $0x8028f4,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801b70:	c7 44 24 04 0c 29 80 	movl   $0x80290c,0x4(%esp)
  801b77:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801c43:	c7 04 24 13 29 80 00 	movl   $0x802913,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801ee0:	c7 44 24 04 2b 29 80 	movl   $0x80292b,0x4(%esp)
  801ee7:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80209c:	c7 04 24 38 29 80 00 	movl   $0x802938,(%esp)
  ...
  8020b2:	e8 4c e0 ff ff       	call   800103 <vcprintf>
	cprintf("\n");
  8020b7:	c7 04 24 24 29 80 00 	movl   $0x802924,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802190:	c7 44 24 08 5c 29 80 	movl   $0x80295c,0x8(%esp)
  802197:	00 
  802198:	c7 44 24 04 53 00 00 	movl   $0x53,0x4(%esp)
  80219f:	00 
  8021a0:	c7 04 24 6f 29 80 00 	movl   $0x80296f,(%esp)
