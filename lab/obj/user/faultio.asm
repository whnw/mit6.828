...
read_eflags(void)
{
  ...
  800041:	c7 04 24 c0 24 80 00 	movl   $0x8024c0,(%esp)
...
outb(int port, uint8_t data)
{
  ...
  800055:	c7 04 24 ce 24 80 00 	movl   $0x8024ce,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800245:	0f be 80 f2 24 80 00 	movsbl 0x8024f2(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800360:	ff 24 95 40 26 80 00 	jmp    *0x802640(,%edx,4)
  ...
  800420:	c7 44 24 08 d9 28 80 	movl   $0x8028d9,0x8(%esp)
  800427:	00 
  ...
  800454:	75 05                	jne    80045b <vprintfmt+0x185>
				p = "(null)";
  800456:	be 03 25 80 00       	mov    $0x802503,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800aae:	00 
  800aaf:	c7 44 24 08 03 28 80 	movl   $0x802803,0x8(%esp)
  800ab6:	00 
  800ab7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800abe:	00 
  800abf:	c7 04 24 20 28 80 00 	movl   $0x802820,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b40:	00 
  800b41:	c7 44 24 08 03 28 80 	movl   $0x802803,0x8(%esp)
  800b48:	00 
  800b49:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b50:	00 
  800b51:	c7 04 24 20 28 80 00 	movl   $0x802820,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b93:	00 
  800b94:	c7 44 24 08 03 28 80 	movl   $0x802803,0x8(%esp)
  800b9b:	00 
  800b9c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ba3:	00 
  800ba4:	c7 04 24 20 28 80 00 	movl   $0x802820,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800be6:	00 
  800be7:	c7 44 24 08 03 28 80 	movl   $0x802803,0x8(%esp)
  800bee:	00 
  800bef:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bf6:	00 
  800bf7:	c7 04 24 20 28 80 00 	movl   $0x802820,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c39:	00 
  800c3a:	c7 44 24 08 03 28 80 	movl   $0x802803,0x8(%esp)
  800c41:	00 
  800c42:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c49:	00 
  800c4a:	c7 04 24 20 28 80 00 	movl   $0x802820,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c8c:	00 
  800c8d:	c7 44 24 08 03 28 80 	movl   $0x802803,0x8(%esp)
  800c94:	00 
  800c95:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c9c:	00 
  800c9d:	c7 04 24 20 28 80 00 	movl   $0x802820,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cdf:	00 
  800ce0:	c7 44 24 08 03 28 80 	movl   $0x802803,0x8(%esp)
  800ce7:	00 
  800ce8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cef:	00 
  800cf0:	c7 04 24 20 28 80 00 	movl   $0x802820,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800d54:	00 
  800d55:	c7 44 24 08 03 28 80 	movl   $0x802803,0x8(%esp)
  800d5c:	00 
  800d5d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d64:	00 
  800d65:	c7 04 24 20 28 80 00 	movl   $0x802820,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  800ed1:	42                   	inc    %edx
  800ed2:	8b 04 95 ac 28 80 00 	mov    0x8028ac(,%edx,4),%eax
  ...
  800eed:	c7 04 24 30 28 80 00 	movl   $0x802830,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80114b:	c7 04 24 71 28 80 00 	movl   $0x802871,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801221:	c7 04 24 8d 28 80 00 	movl   $0x80288d,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8012d8:	c7 04 24 50 28 80 00 	movl   $0x802850,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80155c:	c7 44 24 0c c0 28 80 	movl   $0x8028c0,0xc(%esp)
  801563:	00 
  801564:	c7 44 24 08 c7 28 80 	movl   $0x8028c7,0x8(%esp)
  80156b:	00 
  80156c:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  801573:	00 
  801574:	c7 04 24 dc 28 80 00 	movl   $0x8028dc,(%esp)
  80157b:	e8 00 0b 00 00       	call   802080 <_panic>
	assert(r <= PGSIZE);
  801580:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801585:	7e 24                	jle    8015ab <devfile_read+0x84>
  801587:	c7 44 24 0c e7 28 80 	movl   $0x8028e7,0xc(%esp)
  80158e:	00 
  80158f:	c7 44 24 08 c7 28 80 	movl   $0x8028c7,0x8(%esp)
  801596:	00 
  801597:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  80159e:	00 
  80159f:	c7 04 24 dc 28 80 00 	movl   $0x8028dc,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801672:	c7 44 24 04 f3 28 80 	movl   $0x8028f3,0x4(%esp)
  801679:	00 
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801a84:	c7 44 24 0c ff 28 80 	movl   $0x8028ff,0xc(%esp)
  801a8b:	00 
  801a8c:	c7 44 24 08 c7 28 80 	movl   $0x8028c7,0x8(%esp)
  801a93:	00 
  801a94:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  801a9b:	00 
  801a9c:	c7 04 24 14 29 80 00 	movl   $0x802914,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801ae2:	c7 44 24 0c 20 29 80 	movl   $0x802920,0xc(%esp)
  801ae9:	00 
  801aea:	c7 44 24 08 c7 28 80 	movl   $0x8028c7,0x8(%esp)
  801af1:	00 
  801af2:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  801af9:	00 
  801afa:	c7 04 24 14 29 80 00 	movl   $0x802914,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801b80:	c7 44 24 04 2c 29 80 	movl   $0x80292c,0x4(%esp)
  801b87:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801c23:	0f b6 c0             	movzbl %al,%eax
		nn = thisenv->env_runs;
  801c26:	8b 15 08 40 80 00    	mov    0x804008,%edx
  ...
  801c53:	c7 04 24 33 29 80 00 	movl   $0x802933,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801ef0:	c7 44 24 04 4b 29 80 	movl   $0x80294b,0x4(%esp)
  801ef7:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8020ac:	c7 04 24 58 29 80 00 	movl   $0x802958,(%esp)
  ...
  8020c2:	e8 4c e0 ff ff       	call   800113 <vcprintf>
	cprintf("\n");
  8020c7:	c7 04 24 44 29 80 00 	movl   $0x802944,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  80212f:	a1 08 40 80 00       	mov    0x804008,%eax
  802134:	8b 40 78             	mov    0x78(%eax),%eax
  802137:	89 06                	mov    %eax,(%esi)
	}
	return thisenv->env_ipc_value;
  802139:	a1 08 40 80 00       	mov    0x804008,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8021a0:	c7 44 24 08 7c 29 80 	movl   $0x80297c,0x8(%esp)
  8021a7:	00 
  8021a8:	c7 44 24 04 53 00 00 	movl   $0x53,0x4(%esp)
  8021af:	00 
  8021b0:	c7 04 24 8f 29 80 00 	movl   $0x80298f,(%esp)
